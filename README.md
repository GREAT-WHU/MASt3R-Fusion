...
pip install torch==2.5.1+cu124 torchvision==0.18.1+cu124 torchaudio==2.5.1 --index-url https://download.pytorch.org/whl/cu124
...
Next, compile and install the **modified version of GTSAM**,  
